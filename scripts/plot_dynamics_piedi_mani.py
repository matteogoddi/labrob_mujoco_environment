...
try:
    sim_left_foot = pd.read_csv("dynamics_left_foot_wrench.csv")
    sim_right_foot = pd.read_csv("dynamics_right_foot_wrench.csv")
    sim_left_hand = pd.read_csv("dynamics_left_hand_wrench.csv")
    sim_right_hand = pd.read_csv("dynamics_right_hand_wrench.csv")
...
plot_subplot(axes[1, 0], sim_left_hand, r"left hand wrench", "N / Nm", "f_", "f")

# Grafico 4 (Riga 1, Colonna 1)
plot_subplot(axes[1, 1], sim_right_hand, r"right hand wrench", "N / Nm", "f_", "f")
