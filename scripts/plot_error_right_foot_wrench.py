...
try:
    df = pd.read_csv("error_right_foot_wrench.csv")
except FileNotFoundError:
    print("Errore: file 'error_right_wrench.csv' non trovato. Esegui prima il programma C++.")
    exit()
...
plt.title("Errore nella ricostruzione del wrench del priede destro")
plt.xlabel("Tempo (s)")
