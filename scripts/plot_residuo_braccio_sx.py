...
try:
    df = pd.read_csv("residuo_braccio_sx.csv")
except FileNotFoundError:
    print("Errore: file 'residuo_braccio_sx.csv' non trovato. Esegui prima il programma C++.")
    exit()
...
plt.title("Mujoco Residuo applicato al braccio sinistro")
plt.xlabel("Tempo (s)")
