...
try:
    df = pd.read_csv("reconstructed_left_wrench.csv")
except FileNotFoundError:
    print("Errore: file 'reconstructed_left_wrench.csv' non trovato. Esegui prima il programma C++.")
    exit()
...
plt.title("Ricostruzione del Wrench applicato al Piede Sinistro")
plt.xlabel("Tempo (s)")
