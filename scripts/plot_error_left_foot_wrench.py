...
try:
    df = pd.read_csv("error_left_foot_wrench.csv")
except FileNotFoundError:
    print("Errore: file 'left_right_wrench.csv' non trovato. Esegui prima il programma C++.")
    exit()
...
plt.title("Errore nella ricostruzione del wrench del priede sinistro")
plt.xlabel("Tempo (s)")
