...
try:
    df = pd.read_csv("coppie_esterne_dinamica_inversa.csv")
except FileNotFoundError:
    print("Errore: file 'coppie_esterne_dinamica_inversa.csv' non trovato. Esegui prima il programma C++.")
    exit()
