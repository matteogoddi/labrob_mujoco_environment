...
try:
    df = pd.read_csv("reconstructed_right_wrench.csv")
except FileNotFoundError:
    print("Errore: file 'reconstructed_right_wrench.csv' non trovato. Esegui prima il programma C++.")
    exit()
...
plt.title("Ricostruzione del Wrench applicato al Piede Destro")
plt.xlabel("Tempo (s)")
